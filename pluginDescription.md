Good news, this plugin supports Dart/Java/Kotlin/JavaScript/TypeScript/PHP/PHP, no need to install multiple anymore. You can uninstall the old plugin and then install this one.
