...
class CslePhpInspection : CsleLocalInspectionTool() {
    ...
    private fun isSpecialCallExpression(element: PsiElement): Boolean {
        // 获取参数列表中的位置上下文
//        val parameter = element.parentOfType<Parameter>()
//        val functionReference = element.parentOfType<FunctionReference>()
//        val methodReference = element.parentOfType<MethodReference>()
//        val methodReference = PsiTreeUtil.getParentOfType(parameter, MethodReference::class.java)
//        debugPrintln("parameter=${parameter != null}")
//        debugPrintln("functionReference=${functionReference != null}")
//        debugPrintln("methodReference=${methodReference != null}")
...
//                debugPrintln("text=${expression?.text}, visitPhpStringLiteralExpression")
//            }
//
//            override fun visitPhpPrint(printExpression: PhpPrintExpression?) {
//                super.visitPhpPrint(printExpression)
//            }
//
//            override fun visitPhpEchoStatement(echoStatement: PhpEchoStatement?) {
//                super.visitPhpEchoStatement(echoStatement)
//            }
//        }
//    }
